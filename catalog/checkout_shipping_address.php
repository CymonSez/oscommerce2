...
<?php require(DIR_WS_INCLUDES . 'form_check.js.php'); ?>
    ...
    <?php echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"', true); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
